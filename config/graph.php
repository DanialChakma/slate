...
class Constants
{
    const CLIENT_ID          = '4e913ea3-88ab-486a-9287-768862d035e5';
    const CLIENT_SECRET      = 'BHRwgq9YK0PGEXVcsiKMawS';
    const REDIRECT_URI       = 'https://45.249.100.46/oauth';
    const AUTHORITY_URL      = 'https://login.microsoftonline.com/common';
    const AUTHORIZE_ENDPOINT = '/oauth2/v2.0/authorize';
    const TOKEN_ENDPOINT     = '/oauth2/v2.0/token';
    const RESOURCE_ID        = 'https://graph.microsoft.com';
    const SENDMAIL_ENDPOINT  = '/v1.0/me/sendmail';
    const SCOPES             = 'profile openid email offline_access User.Read Mail.Send Calendars.ReadWrite';
