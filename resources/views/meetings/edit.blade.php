                ...
                <form class="form-horizontal" method="POST" role="form" action = "{{route( 'meetings.update',[ 'id'=>$meeting->id ] )}}" >
                    ...
                    <div class="input-area {{ $errors->has('date') || $errors->has('start_time') || $errors->has('end_time') ? ' has-error' : '' }}">
                        ...
                        <div class="three columns">
                            <input value="{{ date("d M, Y",strtotime($meeting->start_time)) }}"  id="date" name="date" class="input-icon icon-calender" type="text" placeholder="Date">
                            @if ($errors->has('date'))
                                <span class="help-block">
                        ...
                        <div class="two columns">
                            <input value="{{ date("h:i A",strtotime($meeting->start_time)) }}" name="start_time" id="start_time" class="input-icon icon-time" type="text" placeholder="Start Time">
                        ...
                        <div class="two columns">
                            <input value="{{ date("h:i A",strtotime($meeting->end_time)) }}" name="end_time" id="end_time" class="input-icon icon-time" type="text" placeholder="End Time">
