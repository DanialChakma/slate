		...
		<div class="row">
			<div class="col-sm-6"><h1>Update Status<h1></div>
                ...
                <div class="button-area">
                    ...
                    <a href="#" id="complete" name="complete"  class="big-btn" id="btn-com">Complete</a>
                    <a href="#" id="reschedule" name="reschedule" class="big-btn yellowbtn">Reschedule</a>
                    <a href="#" id="cancel" name="cancel" class="big-btn redbtn">Cancel</a>
                </div>
        ...
        $(document).ready(function() {
            ...
            $("#reschedule").on('click',function(e){
                ...
                var content =   '<div class="row">'+
                                    '<div class="col-md-3"></div>'+
                                    '<div class="col-md-6">' +
                                        '<input placeholder="Reschedule date"  id="date" name="date" class="input-icon icon-calender" type="text" readonly/>'
                                ...
                                +'<div class="row">'+
                                        '<div class="col-md-3"></div>'+
                                        '<div class="col-md-6">' +
                                            '<input placeholder="Start time" class="input-icon icon-time"  type="text" value="" name="starttime" id="starttime" readonly/>'
                                ...
                                +'<div class="row">'+
                                            '<div class="col-md-3"></div>'+
                                            '<div class="col-md-6">' +
                                                '<input placeholder="End time" class="input-icon icon-time" type="text"  name="endtime" id="endtime" readonly/>'
                                            +'</div>'
                                            +'<div class="col-md-3"></div>'
                                +'</div>'
