                ...
                <form  method="POST" action="{{ route('meetings.store') }}">
                    ...
                    <div class="input-area {{ $errors->has('date') || $errors->has('start_time') || $errors->has('end_time') ? ' has-error' : '' }}">
                        ...
                        <div class="three columns">
                            <input name="date" data-range="false" data-multiple-dates-separator=" - " data-language="en" class="datepicker-here input-icon icon-calender" type="text">
                            @if ($errors->has('date'))
                                <span class="help-block">
                        ...
                        <div class="two columns">
                            <input name="start_time" id="start_time" class="only-time input-icon icon-time" type="text">
                        ...
                        <div class="two columns">
                            <input name="end_time" id="end_time" class="only-time input-icon icon-time" type="text">
                    ...
                    <div id="contacts" class="contacts input-area">
                        <div id="contact" class="contact input-area">
                            ...
                            <div class="input-area">
                                ...
                                <div class="five columns"><input placeholder="Email" type="email" class="input-icon icon-email" id="email[]" name="email[]" value="" autofocus></div>
                                <div class="three columns"><input placeholder="Cell Number" type="text" class="input-icon icon-phone" id="phone[]" name="phone[]" value="" autofocus/></div>
                            </div>
                        </div>
                    </div>
