...
<div class="row">
    ...
    <div class="col-sm-6">
        @if(auth()->user()->isAdmin())
            <a href="{{ route('meetings.create') }}" class="big-btn fr">Add Schedule</a>
        @endif
    </div>
</div>
    <div style="width:67%; margin: 0 auto;padding: 10px">
        <!--<div class="header">
            <h1>August 2017</h1>
            <div class="right"></div>
            <div class="left"></div>
        </div>-->
        <div id="calendar"><div id="notification"></div></div>
    ...
    !function () {
        ...
        Calendar.prototype.openDay = function (el) {
            ...
            if (currentOpened && currentOpened.parentNode === el.parentNode) {
                ...
                details = createElement('div', 'details in mCustomScrollbar');
        ...
        Calendar.prototype.renderEvents = function (events, ele, current_day) {
           ...
           events.forEach(function (ev) {
                ...
                var eventAnchor = createElement('a', 'name-span', ev.eventName);
